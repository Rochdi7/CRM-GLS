                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-nowrap table-bordered table-striped mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <th class="table-nowrap" scope="row">Container <code class="fw-normal">max-width</code></th>
                                        <td>None (auto)</td>
                                        <td>540px</td>
                                        <td>720px</td>
                                        <td>960px</td>
                                    ...
                                    <tr>
                                        <th class="table-nowrap" scope="row">Class prefix</th>
                                        <td><code>.col-</code></td>
                                    ...
                                    <tr>
                                        <th class="table-nowrap" scope="row"># of columns</th>
                                        <td colspan="6">12</td>
                                    </tr>
                                    <tr>
                                        <th class="table-nowrap" scope="row">Gutter width</th>
                                        <td colspan="6">2rem (1rem on left and right)</td>
                                    </tr>
                                    <tr>
                                        <th class="table-nowrap" scope="row">Custom gutters</th>
                                        <td colspan="6">Yes</td>
                                    </tr>
                                    <tr>
                                        <th class="table-nowrap" scope="row">Nestable</th>
                                        <td colspan="6">Yes</td>
                                    </tr>
                                    <tr>
                                        <th class="table-nowrap" scope="row">Column ordering</th>
                                        <td colspan="6">Yes</td>
                                    </tr>
                                </tbody>
                            </table>

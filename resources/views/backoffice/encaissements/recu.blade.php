    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .recu {
            ...
            padding: {{ $format === 'a5x2' ? '2mm 2mm 2mm 6mm' : '3mm 2mm 3mm 6mm' }};
            font-size: {{ $compact ? '7.5pt' : ($mid ? '8pt' : '10pt') }};
        ...
        .logo img { height: {{ $compact ? '9mm' : ($mid ? '10mm' : '13mm') }}; }
        ...
        .row-line {
            ...
            gap: 3mm;
            padding: {{ $format === 'a5x2' ? '0.45mm 0' : '0.7mm 0' }};
        }
        ...
        .signature {
            ...
            margin-top: {{ $compact ? '3mm' : ($format === 'a5x2' ? '3mm' : '5mm') }};
            padding-top: 1.5mm;
        }
        .signature .mention-nr + div { margin-top: {{ $compact ? '2mm' : '3mm' }}; }
        .signature .sig-space { min-height: {{ $compact ? '6mm' : ($format === 'a5x2' ? '4mm' : '10mm') }}; }

        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-md-4" data-reveal data-reveal-delay="200">
                    <div class="card h-100 border-0 shadow-sm fo-card-hover">
                        <div class="card-body p-4">
                            <span class="badge bg-primary rounded-circle p-3 mb-3 fo-card-icon"><i class="ti ti-language fs-24"></i></span>
                            <h5>{{ __('Language Courses') }}</h5>
                            <p class="text-muted mb-0">{{ __('French, Arabic, English and German programs for all levels.') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4" data-reveal data-reveal-delay="400">
                    <div class="card h-100 border-0 shadow-sm fo-card-hover">
                        <div class="card-body p-4">
                            <span class="badge bg-success rounded-circle p-3 mb-3 fo-card-icon"><i class="ti ti-school fs-24"></i></span>
                            <h5>{{ __('Student Portal') }}</h5>
                            <p class="text-muted mb-0">{{ __('Follow your registrations, schedule and results online.') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4" data-reveal data-reveal-delay="600">
                    <div class="card h-100 border-0 shadow-sm fo-card-hover">
                        <div class="card-body p-4">
                            <span class="badge bg-info rounded-circle p-3 mb-3 fo-card-icon"><i class="ti ti-calendar-check fs-24"></i></span>

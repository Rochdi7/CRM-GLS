    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                icon: 'ti ti-receipt',
                permissions: ['expenses.view', 'refunds.view', 'expense-types.view'],
                matchPaths: ['/backoffice/depenses', '/backoffice/types-depenses', '/backoffice/remboursements'],
            },
        ],
    },
    {
        ...
        items: [
            {
                ...
                icon: 'ti ti-settings',
                permissions: ['centers.view', 'academic-years.view', 'rooms.view'],

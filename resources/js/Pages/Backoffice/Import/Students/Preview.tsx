...
export default function StudentImportPreview({ batch, rows }: StudentImportPreviewProps) {
    ...
    function toggleAllSelectable() {
        const selectableIds = filteredRows.filter((r) => SELECTABLE_STATUSES.includes(r.status)).map((r) => r.id);
